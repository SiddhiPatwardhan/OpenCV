...
# chap 7 - Colour Detection

path = 'Resources/lambo.png'

# The trackbars in this setup are used to help you find the correct HSV (Hue, Saturation, Value) range of a specific color in an image interactively and visually.
